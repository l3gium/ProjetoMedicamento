...
public class Program
{
    ...
    static void ConsultarMedicamentoSintetico(Medicamentos medicamentos)
    {
        ...
        {
            Console.WriteLine($"ID: {medicamento.getId()}, Nome: {medicamento.getNome()}, Laboratório: {medicamento.getLaboratorio()}, Quantidade Disponível: {medicamento.QtdeDisponivel()}");
        }
        else
        {
